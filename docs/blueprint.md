# **App Name**: Dahake Ayurveda

## Core Features:

- Therapy Information: Showcase detailed information about Ayurvedic therapies like Panchakarma, including benefits and the process.
