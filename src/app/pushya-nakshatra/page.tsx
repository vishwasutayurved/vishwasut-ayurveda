...
export const metadata: Metadata = {
  title: 'Pushya Nakshatra 2026 - A Special Day for Ayurvedic Healing',
  description: 'Learn about the significance of Pushya Nakshatra and why it is considered the most auspicious day for starting any Ayurvedic treatment or taking medicines for enhanced benefits. Find the Pushya Nakshatra dates for 2026.',
  openGraph: {
    title: 'Pushya Nakshatra 2026 - A Special Day for Ayurvedic Healing',
    description: 'Find the Pushya Nakshatra dates for 2026 and understand its importance in Ayurveda.',
      ...
      <div className="relative h-80 w-full md:h-[400px]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white">
          <div className="max-w-3xl px-4">
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">Pushya Nakshatra 2026</h1>
