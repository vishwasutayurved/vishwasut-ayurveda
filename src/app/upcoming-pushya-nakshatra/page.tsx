...
export default function UpcomingPushyaNakshatraPage() {
    return (
        <div className="bg-background py-16 sm:py-24">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-bold tracking-tight text-primary sm:text-5xl md:text-6xl">All Upcoming Dates</h1>
                    <p className="mt-4 text-lg text-muted-foreground">Complete list of Pushya Nakshatra dates for 2025-2026</p>
                </div>
