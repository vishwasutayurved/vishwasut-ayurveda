            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    <h3 className="font-headline text-2xl font-bold text-lime-700 mb-4">
                        Pranaa Integrated Ayurveda Health Center
                    </h3>
                    ...
                    <ul className="space-y-4">
                        ...
                        <li className="flex items-center">
                            ...
                            <span className="font-semibold">Mon-Sat: 10:00 AM – 7:00 PM</span>
                        </li>
                        <li className="flex items-start">
                            ...
                            <div className="flex flex-col">
                                ...
                                <a href="tel:+919975797624" className="hover:underline font-semibold">
                                +91 99757 97624
                                </a>
                            </div>
                        </li>
